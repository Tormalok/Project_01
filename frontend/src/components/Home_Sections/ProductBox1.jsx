...
const ProductBox1 = ({ title }) => {
  ...
  return (
    <div
      className={`scroll-container-wrapper-product-box-1 ${
        title ? 'with-title' : ''
      }`}
      style={{
    ...
    >
      ...
      <div className='scroll-container' ref={scrollContainerRef}>
        <div className='scroll-item-product-box-1'>
          <div className='image-box-product-box-1'></div>
          <div className='info-box-product-box-1'>
